...
const unsigned long SPIPins[4][8] = {
		...
		{PD0, PD1, PD2, PD3, GPIO_PD0_SSI1CLK, GPIO_PD1_SSI1FSS, GPIO_PD2_SSI1RX, GPIO_PD3_SSI1TX},
		// TBD: Fill in rest from pg. 907 of datasheet. Don't forget to add them to the README.
};
